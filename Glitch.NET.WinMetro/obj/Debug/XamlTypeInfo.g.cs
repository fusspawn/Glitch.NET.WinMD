...
using Glitch.NET.WinMetro.XamlTypeInfo;
...
namespace Glitch.NET.WinMetro.XamlTypeInfo
{
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new Glitch.NET.WinMetro.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "Glitch.NET.WinMetro.MainPage":
                userType = new XamlUserType(this, typeName, typeof(Glitch.NET.WinMetro.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"));
